...
\item{Implementation of message services and data sharing}
\item{Code generators and deployment tool in python, ansible like, logs, interface database in postgres}
\item{Rest API for driving the simulator, backend python flask}
