...
\usepackage[scale=1,top=1cm,bottom=1cm,left=0.5cm,right=0.5cm,includeheadfoot]{geometry}
...
\usepackage{eso-pic}
\backgroundsetup{contents={\includegraphics[width=5cm,angle=100]{img2.jpg}}}
%\AddToShipoutPicture*{
%    \put(0,0){
...
%\usepackage{marvosym}
\newcommand\itemformation{\item[\textbf{}]}
...
\newcommand\cventry[6]{
\transparent{0.5}\fcolorbox{white}{fondentreprise}{\makebox[15.5cm]{\makebox [4cm][l]{
